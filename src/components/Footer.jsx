    ...
    <div className="lg:w-[87%] w-[98%] mx-auto mt-24 md:px-0 px-3">
      ...
      <div className=" md:gap-0 gap-4 items-center justify-center">
        ...
        <p className="mt-8 text-xl">
          Here, this is not an official GEICO website., Amica Mutual, Progressive, Farmers, 21st Century, American Family, or any Insurance   Provider but Official Site of getquotenow.store (Marketing Partner). All of the logos used in getquotenow.store are the property of their respective owners and are protected by copyright and trademark laws. All trademarks, logos, and related symbols remain the property of their respective owners and are used by getquotenow.store solely to describe the products and services offered by each respective trademark holder. The use of any third-party trademarks on this site does not indicate any relationship between getquotenow.store and the holders of those trademarks, nor does it imply any endorsement of getquotenow.store by the holders of those trademarks. We may send updates to the mobile number/email id registered with us. The content is for information purposes only and does not constitute an offer to avail of any service. Prices mentioned are subject to change without notice and properties mentioned are subject to availability.
        </p>
