        ...
        <div className="flex md:flex-row flex-col lg:w-[87%] w-[98%] mx-auto justify-between mt-16 lg:mt-60">
          <div className="text-start lg:w-[580px] md:w-[440px] w-[100%]">
            ...
            >
              ...
              , and <span>21st Century Insurance</span>.
            </p>
            <p
              className="lg:text-[24px] text-[16px] font-normal text-[#69796F] mt-6 leading-[2em]"
              style={{ fontFamily: "Open Sans" }}
            >
              Our mission is to simplify the insurance bill payment process,
              giving you the convenience to pay your bills online quickly and
              without hassle. Whether you need to pay your auto insurance,
              homeowners insurance, or any other insurance type, we provide a
              one-stop platform for all your needs.
            </p>
          </div>
          <div className="md:w-[42.8%] w-[100%] lg:h-[500px] md:h-[360px] h-[480px] md:mt-0 mt-12">
